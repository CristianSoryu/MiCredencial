...
<head>
    ...
    <title>Solicitudes - Universidad Libre</title>
...
<body>
    ...
    <header class="header">
        ...
        <h2 style="color: white; margin-top: 20px; text-align: center;">Carnet Universitario</h2>
    </header>

    <div class="contenedor" style="max-width: 800px; padding: 20px;">
        <h2 style="text-align: center; color: #333; margin-bottom: 20px;">Solicitudes de Pre-registro</h2>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn-rechazar"><i class="fas fa-times"></i> Rechazar</button>
                    </td>
                </tr>
                <tr>
                    <td>Ana Martínez</td>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <p><i class="fas fa-map-marker-alt"></i> Av. 4ta n.º 12n-81 - El Bosque</p>
            </div>
            ...
            <div class="footer-section">
                ...
                <a href="https://www.unilibre.edu.co/cucuta/" target="_blank">Seccional Cúcuta</a>
