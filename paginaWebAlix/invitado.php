...
<head>
    ...
    <title>Invitado - Verificacion de Carnet</title>
...
<body>
    ...
    <header class="header">
        ...
        <h2 style="color: white; margin-top: 20px; text-align: center;">Acceso Invitado</h2>
    </header>

    <div class="contenedor">
        <div class="login">
            <p>Esta pagina permite verificar carnets.</p>

            <label>Ingresar numero de identificacion:</label>
            <input type="text" placeholder="Ej: 12345678">
            
            <button>Verificar carnet</button>
