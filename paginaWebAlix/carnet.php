...
<head>
    ...
    <title>Carnet Electronico - Universidad Libre</title>
...
<body>
    ...
    <div class="carnet">
        <img src="IMG/foto.jpeg" alt="Foto de Perfil" id="foto-perfil">
        <input type="file" id="foto-input" accept="image/*" hidden>
        <button type="button" id="cambiar-foto-btn" class="boton-cambiar-foto">
...
<p><b>ID:</b> <span id="carnet-id"><?php echo $usuario['tipo_documento'] . ' ' . $usuario['documento']; ?></span></p>
        ...
        <p><b>Vence:</b> <span id="carnet-vencimiento">2026-2</span></p>

        <div id="qrcode"></div>

        <a href="index.php" class="volver" style="margin-top: 15px; font-weight: bold;">
            <i class="fas fa-arrow-left"></i> Volver al inicio
        </a>

        <a href="cambiar-contrasena.php" class="volver" style="margin-top: 15px; font-weight: bold;">
            <i class="fas fa-key"></i> Cambiar contraseña
        </a>

        <button onclick="logout()" style="background: #333; margin-top: 20px; padding: 10px; font-size: 12px;">
