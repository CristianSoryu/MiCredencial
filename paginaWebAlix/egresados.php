...
<head>
    ...
    <title>Egresados no graduados - Universidad Libre</title>
...
<body>
    ...
    <header class="header">
        ...
        <h2 style="color: white; margin-top: 20px; text-align: center;">Egresados no graduados</h2>
    </header>

    <div class="contenedor">
        <div class="login">
            <p style="color: #666; font-size: 14px; margin-bottom: 20px;">Solicitud de renovacion o carnet digital</p>

            <form action="#" method="POST">
                <input type="text" placeholder="Nombre completo" required>
                <input type="text" placeholder="Numero de identificacion" required>
                <input type="email" placeholder="Correo electronico institucional / personal" required>
                
                <select required>
                    <option value="" disabled selected>Seleccione su programa academico</option>
                    <option value="derecho">Derecho</option>
                    <option value="ingenieria-tic">Ingenieria en TIC</option>
                    <option value="ingenieria-civil">Ingenieria Civil</option>
                    <option value="ingenieria-industrial">Ingenieria Industrial</option>
                    <option value="comunicacion-corporativa">Comunicacion Corporativa</option>
            ...
            <a href="index.php" style="margin-top: 20px; display: block; font-weight: bold;">
