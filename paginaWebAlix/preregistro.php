...
<head>
    ...
    <title>Pre registro - Carnet Digital</title>
...
<body>
    <header class="header">
        ...
        <h2 style="color: white; margin-top: 20px; text-align: center;">Solicitud de Registro</h2>
    </header>
    ...
    <div class="contenedor">
        <div class="login">
            ...
            <form>
                ...
                <input type="email" placeholder="ejemplo@unilibre.edu.co">

                <label>Programa académico:</label>
                <input type="text" placeholder="Ej: Derecho">
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <a href="https://www.kawak.com.co/unilibre/pqrs/pqrs_index.php" target="_blank">PQRS - Soporte Técnico</a>
            </div>
