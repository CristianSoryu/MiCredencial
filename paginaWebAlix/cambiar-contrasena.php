...
<head>
    ...
    <title>Cambiar Contrasena - Carnet Digital</title>
...
<body>
    <header class="header">
        ...
        <h2 style="color: white; margin-top: 20px; text-align: center;">Cambiar contraseña</h2>
    </header>

    <div class="contenedor">
        <div class="login">
            <p style="color: #666; font-size: 14px; line-height: 1.5;">
                Actualiza tu contraseña de acceso para la sesion actual.
            </p>
            ...
            <form id="change-password-form">
                ...
                <input type="password" id="new-password" placeholder="Minimo 8 caracteres" required>

                <label for="confirm-password">Confirmar nueva contraseña</label>
                <input type="password" id="confirm-password" placeholder="Repite la nueva contraseña" required>

                <button type="submit">Guardar nueva contraseña</button>
            </form>

            <p id="change-password-message" style="display: none; margin-top: 15px; font-size: 14px; line-height: 1.5;"></p>
